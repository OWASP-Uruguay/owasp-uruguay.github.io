export const es = {
  ...
  participantsDescription: "Un lugar de encuentro para desarrolladores, profesionales de ciberseguridad, expertos en AppSec, DevOps, DevSecOps, CISOs, CIOs. ¡Un espacio de networking imperdible!",
  speakers: "Speakers",
  speakersDescription: "Speakers destacados presentando temas vinculados al desarrollo seguro. ¡Charlas y talleres  que no te podés perder!",
  days: "Días",
  ...
  callToRegistrationButton: "Tickets en Eventbrite",

  callForPresentations: "Convocatoria de presentaciones",
  callForPresentationsDescription: "La conferencia OWASP AppSec Days es una conferencia sobre la seguridad de las aplicaciones. Incluye temas dirigidos a profesionales de TI especializados tanto en seguridad como en desarrollo, pruebas, explotación o gestión y gobernanza.",
  callForPresentationsButton: "Acceder al CFP",
  callForTrainers: "Convocatoria de talleres",
  callForTrainersDescription: "La conferencia OWASP AppSec Days es una conferencia sobre la seguridad de las aplicaciones. Incluye temas dirigidos a profesionales de TI especializados tanto en seguridad como en desarrollo, pruebas, explotación o gestión y gobernanza.",
  callForTrainersButton: "Acceder al CFT",

  callForSponsors: "¿Queres convertirte en un Sponsor?",
  callForSponsorsButton: "Descargar el documento con opciones para Sponsors",

  venueDescription1: "Esta sala es apta para el desarrollo de distintos tipos de eventos: empresariales, comerciales, académicos, nacionales e internacionales, videoconferencias, simposios, conciertos, espectáculos.",
  venueDescription2: "El volumen de forma troncocónica alberga el Auditorio Mario Benedetti o Sala de Conferencias y Teleconferencias y la Sala Idea Vilariño en la planta baja del mismo.",
  venueDescription3: "El Auditorio en sí mismo tiene una capacidad locativa de 360 butacas, con un sistema diseñado por la firma Figueras International Seating. Este sistema, llamado Congress Seating, permite presentar diferentes tipos de configuración de Sala.",
  venueDescription4: "Entre sus características podemos mencionar:",
  venueDescription5: "70 posiciones conectadas Internet",
  venueDescription6: "Plataforma hidráulica para 5.000 kgs. (transporte de escenografías e instrumentos desde el subsuelo al escenario)",
  venueDescription7: "4 Canales de traducción simultánea – 100 receptores inalámbricos",
  venueDescription8: "Cabinas de audio e iluminación",
  venueDescription9: "Servicio completo de cafetería",
  venueDescription10: "Servicio de ropería",
  venueDescription11: "En el amplio Foyer del Auditorio se encuentran varios de los murales de los alumnos del pintor uruguayo Joaquín Torres García considerados Patrimonio Histórico Nacional.",

  organizer: "Evento organizado por: Capítulo OWASP Uruguay",
  organizerFounded: "-Fundado en 2010-",
  ...
  trainingFabioDescription: "A medida que los LLM se integran en todo, desde chatbots hasta herramientas de desarrollo internas y plataformas de atención al cliente, introducen una nueva clase de riesgos de seguridad: inyección de comandos, fuga de datos, comportamientos no deseados y mucho más. Este taller de un día completo enseña a ingenieros y profesionales de AppSec cómo diseñar, crear y probar aplicaciones LLM teniendo en cuenta la seguridad.\n" +
      "Los participantes obtendrán una base práctica sobre los principios de desarrollo seguro adaptados a las arquitecturas basadas en LLM, a partir de casos reales, las directrices de OWASP y escenarios prácticos de laboratorio.\n",
  ...
  conferenceAdityaDescription: "Las defensas de seguridad modernas dependen cada vez más de las huellas digitales de los dispositivos para la detección de fraudes y la autenticación. Sin embargo, la mayoría de las técnicas existentes se centran en atributos basados en software que son fáciles de falsificar. En esta charla, presentamos un nuevo enfoque que aprovecha las huellas digitales persistentes a nivel de hardware y de red, lo que hace que el seguimiento y la autenticación de los dispositivos sean mucho más resistentes a la manipulación.\n" +
    "En esta charla, presentamos una nueva generación de métodos de huellas digitales resistentes que aprovechan las peculiaridades a nivel de hardware y las anomalías de la capa de red, como la deriva del RTC, la sincronización de paquetes, las firmas JA4, las señales Bluetooth/Wi-Fi e incluso el almacenamiento en caché de favicons sin JavaScript. Estos métodos funcionan incluso cuando los usuarios emplean herramientas de privacidad como VPN o navegadores antihuellas digitales. Demostraremos cómo las organizaciones pueden utilizar estas técnicas para la detección de fraudes y la autenticación, al tiempo que revelaremos cómo los adversarios pueden explotarlas para el seguimiento sigiloso.",

  conferenceAndresDescription: "Esta charla traza un paralelismo directo entre las tácticas empleadas en un trabajo de RedTeam y las metodologías documentadas en los manuales filtrados de Basterlord y Conti. Se analiza cómo técnicas utilizadas por ransomware gangs —como movimiento lateral, persistencia silenciosa, exfiltración encubierta y dominio total— pueden (y deben) formar parte de simulaciones profesionales si el objetivo es evaluar con realismo la postura de seguridad de una organización. No es una charla sobre herramientas: es una sobre operar como lo haría un adversario real.",

  conferenceAramDescription: "A los equipos de seguridad les encantan las métricas. Bonitos dashboards llenos de estadísticas sobre vulnerabilidades, volumen de alertas, cumplimiento de los SLA en cuanto a tiempos de resolución, horas de formación registradas, etc. Sin embargo, ¿alguna de estas métricas contribuye realmente a que las organizaciones sean más seguras? La incómoda verdad es que la mayoría de las métricas de seguridad son cuestionables, al menos desde un punto de vista científico.\n" +
  ...
  conferenceAugustDescription: "Las aplicaciones funcionan con anuncios. Las redes publicitarias y las empresas de análisis requieren que se instale un SDK en la aplicación para funcionar. Estos SDK están plagados de exploits, vulnerabilidades, rastreo no solicitado y comportamientos repugnantes. En esta charla, repasaremos algunas de esas técnicas y explicaremos cómo a todos los que forman parte de esta industria no les importas tú: los usuarios reales.",

  conferenceAxelDescription: "La Inteligencia Artificial está revolucionando la ciberseguridad como nunca antes. En esta charla, descubrirás cómo el proyecto PentestGPT está redefiniendo el pentesting al automatizar análisis avanzados y detectar vulnerabilidades con precisión asombrosa. Conoce cómo la IA está transformando nuestras estrategias defensivas y marcando un nuevo estándar en la lucha contra las ciberamenazas. Deja que el Junior haga el Pentest y el Senior te dé más valor.",

  conferenceEvaDescription: "El papel de la criptografía en el mundo de la tecnología es innegable, pero... ¿cómo es posible que los métodos de cifrado que se remontan al año 1900 a. C. sean tan importantes en el siglo XXI? ¿Qué relación pueden tener un número aleatorio, la derrota de los nazis y los ordenadores cuánticos?\n" +
  ...
  conferenceJoseDescription: "¿Estás desarrollando o usando inteligencia artificial en tus aplicaciones? Entonces necesitas más que un modelo inteligente: necesitas un modelo seguro.\n" +
