export const en = {
  ...
  conferenceMatoDescription: "In this talk, we will explore how to natively incorporate security practices into a DevOps lifecycle, evolving towards a DevSecOps process. We will look at how to apply the shift-left approach to detect vulnerabilities from the beginning, integrate AppSec tools into a CI/CD pipeline, and design automatic controls that do not slow down the pace of delivery. We will also address the importance of collaboration between development, operations, and security teams, focusing efforts on visibility and speed. By the end, you will have a clear roadmap for getting started with continuous software security.",

  conferenceAndresDescription: "This talk draws a direct parallelism between the tactics used in RedTeam work and the methodologies documented in the leaked Basterlord and Conti manuals. It analyzes how techniques used by ransomware gangs—such as lateral movement, silent persistence, covert exfiltration, and total control—can (and should) be part of professional simulations if the goal is to realistically assess an organization's security posture. This is not a talk about tools: it is about operating as a real adversary would.",
