...
import MaterialInput from "@/examples/MaterialInput.vue";
import MaterialTextArea from "@/examples/MaterialTextArea.vue";
import MaterialButton from "@/examples/MaterialButton.vue";
import MaterialSwitch from "@/examples/MaterialSwitch.vue";
